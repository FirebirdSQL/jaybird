...
Bounce Castle seems to support the 64-bit counter variant of ChaCha (not yet verified).
...
[NOTE]
====
This decision assumes that Bounce Castle indeed supports ChaCha with 64-bit counter.
