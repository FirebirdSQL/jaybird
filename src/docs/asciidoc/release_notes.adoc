...
We limit support to Java LTS releases (Java 8, Java 11, Java 17, Java 21, and Java 25), and the latest Java release.
Currently, that means we support Java 8, Java 11, Java 17, Java 21, and Java 25.
...
The value of `JaybirdTypeCodes.DECFLOAT` will be updated in the first Jaybird 5 release _after_ the release of Java 26 (in March 2026).
