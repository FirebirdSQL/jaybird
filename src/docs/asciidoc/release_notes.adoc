...
* Changed: removed debugging logging in `AbstractFbStatement.ensureClosedCursor` (https://github.com/FirebirdSQL/jaybird/issues/604[jaybird#604])
+
...
Jaybird 5 will serve as a form of LTS for Java 8 and 11, with maintenance release at least until the release of Jaybird 7.
