...
* Dependency update: updated `net.java.dev.jna:jna-jpms` from 5.15.0 to 5.17.0 (used by native and embedded protocols) (https://github.com/FirebirdSQL/jaybird/issues/855[#855])
