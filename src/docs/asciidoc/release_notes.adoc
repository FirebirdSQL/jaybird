...
Jaybird {version_wo_target} was tested against Firebird 2.5.9, 3.0.7, and 4.0.0, but should also support other Firebird versions from 2.5 and up.
...
Currently, that means we support Java 11 and Java 17.
...
[#multirow-returning]
=== Firebird 5 multi-row RETURNING support
...
Jaybird 6 will drop support for Firebird 2.5 (see also https://github.com/FirebirdSQL/jaybird/tree/master/devdoc/jdpjdp-2021-03-drop-firebird-2-5-support.md[jdp-2021-03]).
