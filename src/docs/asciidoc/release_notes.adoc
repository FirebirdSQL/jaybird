...
* Fixed: `DatabaseMetaData.getIdentifierQuoteString()` should return `" "` (space) for dialect 1 database (https://github.com/FirebirdSQL/jaybird/issues/714[jaybird#714])
