...
Contrary to Jaybird 4, Maven relocation artifacts `jaybird-jdk17` for Java 7 and `jaybird-jdk18` for Java 8 are no longer provided.
...
The above legacy URL format is a simplification.
