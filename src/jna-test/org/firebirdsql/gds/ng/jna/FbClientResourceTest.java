...
public class FbClientResourceTest {
    ...
    /**
     * Rationale: due to code changes, the impose implementation didn't work but instead logged an exception
     */
    @Test
    public void testDisposeImplementation() throws Exception {
        ...
        FbClientResource resource = (FbClientResource) resourceField.get(factory);
