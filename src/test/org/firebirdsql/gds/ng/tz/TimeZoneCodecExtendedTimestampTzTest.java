...
public class TimeZoneCodecExtendedTimestampTzTest extends TimeZoneCodecAbstractTimestampTzTest {

    public TimeZoneCodecExtendedTimestampTzTest() {
        super(SQL_TIMESTAMP_TZ_EX);
    }
