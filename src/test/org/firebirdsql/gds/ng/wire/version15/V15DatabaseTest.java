...
import org.firebirdsql.gds.ng.wire.version13.V13DatabaseTest;
...
public class V15DatabaseTest extends V13DatabaseTest {
    ...
    public V15DatabaseTest() {
        this(new V15CommonConnectionInfo());
    }

    protected V15DatabaseTest(V15CommonConnectionInfo commonConnectionInfo) {
