...
import org.firebirdsql.gds.ng.wire.version13.TestV13Transaction;
 ...
 * @since 4.0
 */
public class TestV15Transaction extends TestV13Transaction {

    @ClassRule
    public static final RequireProtocol requireProtocol = requireProtocolVersion(15);

    public TestV15Transaction() {
        this(new V15CommonConnectionInfo());
    }

    protected TestV15Transaction(V15CommonConnectionInfo commonConnectionInfo) {
