...
import org.firebirdsql.gds.ng.wire.version13.TestV13Service;
 ...
 * @since 4.0
 */
public class TestV15Service extends TestV13Service {

    @ClassRule
    public static final RequireProtocol requireProtocol = requireProtocolVersion(15);

    public TestV15Service() {
        this(new V15CommonConnectionInfo());
    }

    protected TestV15Service(V15CommonConnectionInfo commonConnectionInfo) {
