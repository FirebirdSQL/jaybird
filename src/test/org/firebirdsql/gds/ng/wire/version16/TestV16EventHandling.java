...
import org.firebirdsql.gds.ng.wire.version15.TestV15EventHandling;
 ...
 * @since 4.0
 */
public class TestV16EventHandling extends TestV15EventHandling {

    @ClassRule
    public static final RequireProtocol requireProtocol = requireProtocolVersion(16);

    public TestV16EventHandling() {
        this(new V16CommonConnectionInfo());
    }

    protected TestV16EventHandling(V16CommonConnectionInfo commonConnectionInfo) {
