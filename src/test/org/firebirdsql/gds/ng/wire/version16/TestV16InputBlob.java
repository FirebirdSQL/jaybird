...
import org.firebirdsql.gds.ng.wire.version15.TestV15InputBlob;
 ...
 * @since 4.0
 */
public class TestV16InputBlob extends TestV15InputBlob {

    @ClassRule
    public static final RequireProtocol requireProtocol = requireProtocolVersion(16);

    public TestV16InputBlob() {
        this(new V16CommonConnectionInfo());
    }

    protected TestV16InputBlob(V16CommonConnectionInfo commonConnectionInfo) {
