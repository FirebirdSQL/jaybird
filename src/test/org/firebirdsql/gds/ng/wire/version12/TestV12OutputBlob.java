...
import org.firebirdsql.gds.ng.wire.version11.TestV11OutputBlob;
 ...
 * @since 3.0
 */
public class TestV12OutputBlob extends TestV11OutputBlob {

    @ClassRule
    public static final RequireProtocol requireProtocol = requireProtocolVersion(12);

    public TestV12OutputBlob() {
        this(new V12CommonConnectionInfo());
    }

    protected TestV12OutputBlob(V12CommonConnectionInfo commonConnectionInfo) {
