...
import org.firebirdsql.gds.ng.wire.version11.V11TransactionTest;
...
public class V12TransactionTest extends V11TransactionTest {
    ...
    public V12TransactionTest() {
        this(new V12CommonConnectionInfo());
    }

    protected V12TransactionTest(V12CommonConnectionInfo commonConnectionInfo) {
