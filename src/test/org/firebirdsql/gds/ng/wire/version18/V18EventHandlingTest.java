 ...
 * @since 5
 */
public class V18EventHandlingTest extends TestV16EventHandling {

    @ClassRule
    public static final RequireProtocol requireProtocol = requireProtocolVersion(18);

    public V18EventHandlingTest() {
        this(new V18CommonConnectionInfo());
    }

    protected V18EventHandlingTest(V18CommonConnectionInfo commonConnectionInfo) {
