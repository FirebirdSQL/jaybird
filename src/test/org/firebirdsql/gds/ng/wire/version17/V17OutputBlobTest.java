...
/**
 * Tests for {@link org.firebirdsql.gds.ng.wire.version10.V10OutputBlob} in the version 17 protocol
 * (note: there is no version 17 specific implementation of this class).
 *
 * @author <a href="mailto:mrotteveel@users.sourceforge.net">Mark Rotteveel</a>
 * @since 5
 */
public class V17OutputBlobTest extends TestV16OutputBlob {

    @ClassRule
    public static final RequireProtocol requireProtocol = requireProtocolVersion(17);

    public V17OutputBlobTest() {
        this(new V17CommonConnectionInfo());
    }

    protected V17OutputBlobTest(V17CommonConnectionInfo commonConnectionInfo) {
