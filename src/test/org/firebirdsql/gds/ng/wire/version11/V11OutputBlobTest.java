...
import org.firebirdsql.gds.ng.wire.version10.V10OutputBlobTest;
 ...
 * @since 3.0
 */
public class V11OutputBlobTest extends V10OutputBlobTest {

    @ClassRule
    public static final RequireProtocol requireProtocol = requireProtocolVersion(11);

    public V11OutputBlobTest() {
        this(new V11CommonConnectionInfo());
    }

    protected V11OutputBlobTest(V11CommonConnectionInfo commonConnectionInfo) {
