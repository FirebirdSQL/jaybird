...
import org.firebirdsql.gds.ng.wire.version10.TestV10InputBlob;
 ...
 * @since 3.0
 */
public class TestV11InputBlob extends TestV10InputBlob {

    @ClassRule
    public static final RequireProtocol requireProtocol = requireProtocolVersion(11);

    public TestV11InputBlob() {
        this(new V11CommonConnectionInfo());
    }

    protected TestV11InputBlob(V11CommonConnectionInfo commonConnectionInfo) {
