...
class FBConnectionTest {
    ...
    void specifyParallelWorkers() throws Exception {
        ...
        try (Connection connection = DriverManager.getConnection(getUrl(), props)) {
            ...
            assertThat(warning, allOf(
                    errorCodeEquals(335545286),
                    fbMessageStartsWith(335545286,
    ...
    void enquoteIdentifier_validCases(String identifier, boolean alwaysDelimit, int dialect, String expected)
            throws Exception {
        try (FirebirdConnection connection =
    ...
    void enquoteIdentifier_invalidCases(String identifier, boolean alwaysDelimit, int dialect,
        ...
        Class<? extends SQLException> expectedException = Class.forName(expectedExceptionName)
                .asSubclass(SQLException.class);
        try (FirebirdConnection connection =
                     getConnectionViaDriverManager(PropertyNames.sqlDialect, String.valueOf(dialect))) {
    ...
    void enquoteIdentifier_invalidCase_tooLong(int dialect) throws SQLException {
        try (FirebirdConnection connection =
            ...
            SQLSyntaxErrorException exception = assertThrows(SQLSyntaxErrorException.class,
