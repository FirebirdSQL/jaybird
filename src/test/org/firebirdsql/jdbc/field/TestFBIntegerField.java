 ...
 */
public class TestFBIntegerField extends BaseJUnit4TestFBField<FBIntegerField, Integer> {
    ...
    public void setBigDecimal_MIN_minus_fraction() throws SQLException {
        expectedException.expect(TypeConversionException.class);
        BigDecimal testValue = new BigDecimal(Integer.MIN_VALUE);
    ...
    public void setDouble() throws SQLException {
        setIntegerExpectations(9157824);
    ...
    public void setLong_MAX_plus_one() throws SQLException {
        ...
        field.setLong(Integer.MAX_VALUE + 1L);
    }
    ...
    public void setLong_MIN_minus_one() throws SQLException {
        ...
        field.setLong(Integer.MIN_VALUE - 1L);
    }
    ...
    public void setShort() throws SQLException {
        setIntegerExpectations(Short.MIN_VALUE);
    ...
    public void setStringNonNull() throws SQLException {
        setIntegerExpectations(5145789);
    ...
    @Override
    protected Integer getNonNullObject() {
        return 1;
    }
}
