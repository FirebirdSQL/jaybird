...
public final class ConfigHelper {
    ...
    public static String getConfigValue(Connection connection, String configOption) throws SQLException {
        FirebirdSupportInfo supportInfo = FirebirdSupportInfo.supportInfoFor(connection);
     ...
     * @param configOption
     *         configuration option name
     * @return value of {@code configOption} if an int, or {@code empty} if it does not exist or has a blank value
     * @throws SQLException
     *         for errors executing the query
