...
public class TestFBMCEventManager extends FBJUnit4TestBase {
    ...
    private FBManagedConnection mc; // Managed connection for listening by event managers
    ...
    public void setUp() throws Exception {
        ...
        mc = (FBManagedConnection) mcf.createManagedConnection(null, null);
    }
    ...
    public void testMultipleManagersOnOneEvent() throws Exception {
        FBMCEventManager fbmcEventManager1 = new FBMCEventManager(mc);
        FBMCEventManager fbmcEventManager2 = new FBMCEventManager(mc);
