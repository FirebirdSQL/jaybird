 ...
 */
public class PingablePooledConnection implements PooledConnection, XConnectionManager, 
    XPingableConnection, XStatementManager 
{
		...
		PingablePooledConnection(Connection connection, String pingStatement, 
		...
		public synchronized boolean ping() {
			if (pingStatement == null) return false;
		...
		public boolean isValid() {
			...
			if (System.currentTimeMillis() - lastPingTime > pingInterval && pingStatement != null)
			    return ping();
			else
			    return true;
		}
            ...
            int resultSetType, int resultSetConcurrency) throws SQLException 
        {
            ...
            synchronized(statements) {
                ...
                stmt = stmtCache.reference(currentConnection.getProxy());
            }
            ...
            synchronized(statements) {
                ...
                while (iter.hasNext()) {
                    ...
                    XCachablePreparedStatement stmt = 
                        (XCachablePreparedStatement)stmtCache.reference(null);
     ...
     */
    public void connectionRolledBack(XConnection connection) throws SQLException {
        if (connection != currentConnection)
            throw new IllegalArgumentException(
                "Specified connection does not correspond " + 
                "current physical connection");
