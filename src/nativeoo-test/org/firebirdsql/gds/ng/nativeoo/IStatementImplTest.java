 ...
 * {@link org.firebirdsql.gds.ng.nativeoo.IStatementImpl}.
 *
 * @since 6.0
 */
class IStatementImplTest extends AbstractStatementTest {
    ...
    public void testSelect_NoParameters_Execute_and_Fetch() throws Exception {
        ...
        // IStatement only executes a single fetch to prevent problems with positioned updates,
