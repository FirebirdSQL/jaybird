...
// @formatter:on
    ...
    private static final Set<String> FATAL_SQL_STATE_CLASSES = singleton(SQLSTATE_CLASS_CONNECTION_ERROR);

    private static final Set<String> FATAL_SQL_STATES = unmodifiableSet(new HashSet<>(Arrays.asList(
