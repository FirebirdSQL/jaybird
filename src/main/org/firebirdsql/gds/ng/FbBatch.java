...
public interface FbBatch extends ExceptionListenable {
     ...
     */
    void addBlob(int index, FirebirdBlob blob)
            throws SQLException;
     ...
     * Add blob in this batch.
     */
    void addSegmentedBlob(int index, BlobParameterBuffer buffer, FirebirdBlob blob)
     ...
     */
    void registerBlob(int index, long existingBlob, FirebirdBlob blob) throws SQLException;
