...
import static org.firebirdsql.gds.JaybirdErrorCodes.jb_invalidGeneratedKeysOption;
...
final class GeneratedKeysSupportFactory {
    ...
    private static final class DefaultGeneratedKeysSupport implements GeneratedKeysSupport {
        ...
        public Query buildQuery(String sql, int autoGeneratedKeys) throws SQLException {
            return switch (autoGeneratedKeys) {
                case Statement.NO_GENERATED_KEYS -> GeneratedKeysQueryBuilder
                        .create(sql, supportedQueryTypes)
                        .forNoGeneratedKeysOption();
                case Statement.RETURN_GENERATED_KEYS -> GeneratedKeysQueryBuilder
                        .create(sql, supportedQueryTypes)
                        .forReturnGeneratedKeysOption(fbDatabaseMetaData);
                default -> throw FbExceptionBuilder.toNonTransientException(jb_invalidGeneratedKeysOption);
            };
        }
    ...
    private static final class DisabledGeneratedKeysSupport implements GeneratedKeysSupport {
        ...
        public Query buildQuery(String sql, int autoGeneratedKeys) throws SQLException {
            return switch (autoGeneratedKeys) {
                case Statement.NO_GENERATED_KEYS -> new Query(false, sql);
                case Statement.RETURN_GENERATED_KEYS -> throw disabled();
                default -> throw FbExceptionBuilder.toNonTransientException(jb_invalidGeneratedKeysOption);
            };
        }
