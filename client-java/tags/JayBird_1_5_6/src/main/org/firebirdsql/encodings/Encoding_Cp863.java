...
public class Encoding_Cp863 extends Encoding_OneByte{

    private static char[] defaultByteToChar = new char[256];
        private static byte[] defaultCharToByte = new byte[256*256];;

        static{
            Initialize("Cp863", defaultByteToChar, defaultCharToByte);
        }
        ...
        public Encoding_Cp863(char[] charMapping) {
            ...
            Initialize("Cp863", byteToChar, charToByte, charMapping);
        }
