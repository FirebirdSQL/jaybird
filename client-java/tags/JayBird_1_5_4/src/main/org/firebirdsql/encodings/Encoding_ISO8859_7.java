...
public class Encoding_ISO8859_7 extends Encoding_OneByte{
    ...
    private static char[] defaultByteToChar = new char[256];
        ...
        static{
            Initialize("ISO8859_7", defaultByteToChar, defaultCharToByte);
        }
        ...
        public Encoding_ISO8859_7(char[] charMapping) {
            byteToChar = new char[256];
            charToByte = new byte[256 * 256];
            Initialize("ISO8859_7", byteToChar, charToByte, charMapping);
        }
