...
public class TestFBDatabaseMetaData extends TestXABase {
    ...
    public void testGetAllSystemTablesSystem() throws Exception {
        ...
        if (metaData.getDatabaseMajorVersion() < 2)
            ...
            sysTableCount = 33;
        else if (metaData.getDatabaseMajorVersion() == 2 && metaData.getDatabaseMinorVersion() == 1)
            sysTableCount = 40;
        else if (metaData.getDatabaseMajorVersion() == 2 && metaData.getDatabaseMinorVersion() == 5)
            sysTableCount = 42;
        else {
