...
public class Encoding_Cp775 extends Encoding_OneByte{

    private static char[] defaultByteToChar = new char[256];
        private static byte[] defaultCharToByte = new byte[256*256];;

        static{
            Initialize("Cp775", defaultByteToChar, defaultCharToByte);
        }
        ...
        public Encoding_Cp775(char[] charMapping) {
            ...
            Initialize("Cp775", byteToChar, charToByte, charMapping);
        }
