...
public abstract class AbstractStatement implements FirebirdStatement, Synchronizable {
    ...
    /**
     * Modify the INSERT statement to include the specified RETURNING columns and
     * execute the statement.
     * 
     * @param sql INSERT statetemnt to execute
     * @param columnNames names of the columns that are to be returned to the 
     * user.
     * 
     * @return number of modified rows (usually 1).
     * 
     * @throws SQLException
     * @throws GDSException
     */
    protected boolean internalExecuteInsertReturning(String sql, String[] columnNames) throws SQLException, GDSException {
        ...
        boolean hasResultSet = execute(modifiedSql.toString());
