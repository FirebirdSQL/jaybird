...
public abstract class AbstractStatement implements FirebirdStatement, Synchronizable {
    ...
    public boolean execute(String sql, int autoGeneratedKeys)
        ...
        boolean hasResultSet = execute(query.getQueryString());
        // Result produced by generatedKeys means there is no normal resultset, so return false here.
        return query.generatesKeys() ? false : hasResultSet;
    }
