    ...
    implements FirebirdPreparedStatement 
{
     ...
     */
    protected AbstractPreparedStatement(GDSHelper c, String sql, 
                                        int rsType, int rsConcurrency, FBObjectListener.StatementListener statementListener) 
        throws SQLException 
    {
        super(c, rsType, rsConcurrency, statementListener);
...
//            if (true)
//                throw new UnsupportedOperationException("Fix the cached result set");
    ...
    protected boolean internalExecute(boolean sendOutParams) throws  SQLException
    {
        ...
        synchronized(syncObject) {
            ...
            for (int i = 0; i < isParamSet.length; i++) {
                ...
                FBFlushableField flushableField = (FBFlushableField)field;
    ...
    public ResultSetMetaData getMetaData() throws  SQLException {
        return new FBResultSetMetaData(fixedStmt. getOutSqlda().sqlvar, gdsHelper);
    }
        ...
        throws GDSException, SQLException
    {
        ...
        for (int i = 0; i < isParamSet.length; i++){
            ...
            if (fields[i] instanceof FBWorkaroundStringField)
                ((FBWorkaroundStringField)fields[i]).setTrimString(trimStrings);
        }
