...
public class GetXXX extends TestModule
{
    ...
    public void run()
    {
        ...
        try
        {
            ...
            for(int i1 = 1; i1 <= testtable.getColumnCount(); i1++)
            {
                ...
                case 6: // '\006'
                case 8: // '\b'
                    test(resultset, "getDouble(" + i1 + ")");
                    double d = resultset.getDouble(i1);
                    result(d);
                ...
                case 7: // '\007'
                    test(resultset, "getFloat(" + i1 + ")");
                    float f = resultset.getFloat(i1);
                    result(f);
                ...
                case 2: // '\002'
                case 3: // '\003'
                    test(resultset, "getBigDecimal(" + i1 + ", " + 16 + ")");
                    BigDecimal bigdecimal = resultset.getBigDecimal(i1, 16);
                    result(bigdecimal);
                    verify(bigdecimal.equals(new BigDecimal("12.1234561234567890")), "The NUMERIC value must match the value used to set it - " + new BigDecimal("12.1234561234567890"));
                    break;

                case 1: // '\001'
                    test(resultset, "getString(" + i1 + ")");
                    String s = resultset.getString(i1);
                    result(s);
                ...
                case 12: // '\f'
                    test(resultset, "getString(" + i1 + ")");
                    String s1 = resultset.getString(i1);
                    result(s1);
                ...
                case 91: // '['
                    test(resultset, "getDate(" + i1 + ")");
                    Date date = resultset.getDate(i1);
                    result(date);
                    verify(date.equals(Date.valueOf("1996-01-01")), "The DATE value must match the value used to set it");
                    break;

                case 92: // '\\'
                    test(resultset, "getTime(" + i1 + ")");
                    Time time = resultset.getTime(i1);
                    result(time);
                    verify(time.equals(Time.valueOf("04:59:59")), "The TIME value must match the value used to set it");
                    break;

                case 93: // ']'
                    test(resultset, "getTimestamp(" + i1 + ")");
                    Timestamp timestamp = resultset.getTimestamp(i1);
                    result(timestamp);
                ...
                case -2:
                    test(resultset, "getBytes(" + i1 + ")");
                    byte abyte0[] = resultset.getBytes(i1);
                    result(abyte0);
                ...
                case -3:
                    test(resultset, "getBytes(" + i1 + ")");
                    byte abyte1[] = resultset.getBytes(i1);
                    result(abyte1);
            ...
            for(int i2 = 1; i2 <= testtable.getColumnCount(); i2++)
            {
                ...
                {
                case -7:
                    test(resultset, "getString(" + i2 + ")");
                    String s2 = resultset.getString(i2);
                    result(s2);
                ...
                case -6:
                    test(resultset, "getString(" + i2 + ")");
                    String s3 = resultset.getString(i2);
                    result(s3);
                ...
                case 5: // '\005'
                    test(resultset, "getString(" + i2 + ")");
                    String s4 = resultset.getString(i2);
                    result(s4);
                ...
                case 4: // '\004'
                    test(resultset, "getString(" + i2 + ")");
                    String s5 = resultset.getString(i2);
                    result(s5);
                ...
                case -5:
                    test(resultset, "getString(" + i2 + ")");
                    String s6 = resultset.getString(i2);
                    result(s6);
                ...
                case 8: // '\b'
                    test(resultset, "getString(" + i2 + ")");
                    String s8 = resultset.getString(i2);
                    result(s8);
                ...
                case 7: // '\007'
                    test(resultset, "getString(" + i2 + ")");
                    String s7 = resultset.getString(i2);
                    result(s7);
                ...
                case 3: // '\003'
                    test(resultset, "getString(" + i2 + ")");
                    String s9 = resultset.getString(i2);
                    result(s9);
                ...
                case 91: // '['
                    test(resultset, "getString(" + i2 + ")");
                    String s10 = resultset.getString(i2);
                    result(s10);
                ...
                case 92: // '\\'
                    test(resultset, "getString(" + i2 + ")");
                    String s11 = resultset.getString(i2);
                    result(s11);
                ...
                case 93: // ']'
                    test(resultset, "getString(" + i2 + ")");
                    String s12 = resultset.getString(i2);
                    result(s12);
                ...
                case -2:
                    test(resultset, "getString(" + i2 + ")");
                    String s13 = resultset.getString(i2);
                    result(s13);
                ...
                case -3:
                    test(resultset, "getString(" + i2 + ")");
                    String s14 = resultset.getString(i2);
                    result(s14);
