...
// Source File Name:   GetStreamNamed.java
...
public class GetStreamNamed extends TestModule
{

    public GetStreamNamed()
    {
    }
    ...
    public void run()
    {
        ...
        try
        {
            ...
            for(int l3 = 1; l3 <= testtable.getColumnCount(); l3++)
            {
                ...
                case 1: // '\001'
                    test(resultset, "getUnicodeStream(" + testtable.getColName(l3) + ")");
                    InputStream inputstream4 = resultset.getUnicodeStream(testtable.getColName(l3));
                    result(inputstream4);
                ...
                case 12: // '\f'
                    test(resultset, "getUnicodeStream(" + testtable.getColName(l3) + ")");
                    InputStream inputstream5 = resultset.getUnicodeStream(testtable.getColName(l3));
                    result(inputstream5);
                ...
                case -2:
                    test(resultset, "getUnicodeStream(" + testtable.getColName(l3) + ")");
                    InputStream inputstream6 = resultset.getUnicodeStream(testtable.getColName(l3));
                    result(inputstream6);
                ...
                case -3:
                    test(resultset, "getUnicodeStream(" + testtable.getColName(l3) + ")");
                    InputStream inputstream7 = resultset.getUnicodeStream(testtable.getColName(l3));
                    result(inputstream7);
            ...
            for(int i5 = 1; i5 <= testtable.getColumnCount(); i5++)
            {
                ...
                case 1: // '\001'
                    test(resultset, "getAsciiStream(" + testtable.getColName(i5) + ")");
                    InputStream inputstream = resultset.getAsciiStream(testtable.getColName(i5));
                    result(inputstream);
                ...
                case 12: // '\f'
                    test(resultset, "getAsciiStream(" + testtable.getColName(i5) + ")");
                    InputStream inputstream1 = resultset.getAsciiStream(testtable.getColName(i5));
                    result(inputstream1);
                ...
                case -2:
                    test(resultset, "getAsciiStream(" + testtable.getColName(i5) + ")");
                    InputStream inputstream2 = resultset.getAsciiStream(testtable.getColName(i5));
                    result(inputstream2);
                ...
                case -3:
                    test(resultset, "getAsciiStream(" + testtable.getColName(i5) + ")");
                    InputStream inputstream3 = resultset.getAsciiStream(testtable.getColName(i5));
                    result(inputstream3);
            ...
            for(int j6 = 1; j6 <= testtable.getColumnCount(); j6++)
            {
                ...
                case -2:
                    test(resultset, "getBinaryStream(" + testtable.getColName(j6) + ")");
                ...
                case -3:
                    test(resultset, "getBinaryStream(" + testtable.getColName(j6) + ")");
                    InputStream inputstream9 = resultset.getBinaryStream(testtable.getColName(j6));
                    result(inputstream9);
