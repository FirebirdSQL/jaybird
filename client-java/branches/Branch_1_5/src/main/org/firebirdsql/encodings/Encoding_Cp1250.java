...
public class Encoding_Cp1250 extends Encoding_OneByte{
    ...
    static{
        Initialize("Cp1250", defaultByteToChar, defaultCharToByte);
    }

    private char[] byteToChar;
    private byte[] charToByte;
    
    public Encoding_Cp1250() {
        byteToChar = defaultByteToChar;
        charToByte = defaultCharToByte;
    }
    
    public Encoding_Cp1250(char[] charMapping) {
        byteToChar = new char[256];
        charToByte = new byte[256 * 256];
        Initialize("Cp1250", byteToChar, charToByte, charMapping);
    }
