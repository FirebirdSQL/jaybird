...
public class Encoding_ISO8859_5 extends Encoding_OneByte{
    ...
    private static char[] defaultByteToChar = new char[256];
        ...
        static{
            Initialize("ISO8859_5", defaultByteToChar, defaultCharToByte);
        }

        private char[] byteToChar;
        private byte[] charToByte;
    
        public Encoding_ISO8859_5() {
            byteToChar = defaultByteToChar;
            charToByte = defaultCharToByte;
        }
    
        public Encoding_ISO8859_5(char[] charMapping) {
            byteToChar = new char[256];
            charToByte = new byte[256 * 256];
            Initialize("ISO8859_5", byteToChar, charToByte, charMapping);
        }
